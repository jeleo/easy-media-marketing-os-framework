...
public class ViewController extends ControllerBus {
    ...
    @RequestMapping(value = VIEW_WEIXIN_LIST, method = RequestMethod.GET)
    public String toWeixinList() {
        return page(VIEW_WEIXIN_LIST);
    }
    ...
    @RequestMapping(value = VIEW_WEIXIN_MENU, method = RequestMethod.GET)
    public String toWeixinMenu() {
        return layout(VIEW_WEIXIN_MENU);
    }
