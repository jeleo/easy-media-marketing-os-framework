...
public class PictureUtil {
    ...
    /** 图片格式：JPG */
    public static final String PICTRUE_FORMATE_JPEG = "jpeg";
    /** 图片格式：JPG */
    public static final String PICTRUE_FORMATE_BMP = "bmp";
    /** 图片格式：GIF */
    public static final String PICTRUE_FORMATE_GIF = "gif";
    /** 图片格式：PNG */
    public static final String PICTRUE_FORMATE_PNG = "png";
    /** 图片大小限制(10M) */
