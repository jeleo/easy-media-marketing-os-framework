...
import easy.media.marketing.os.framework.api.entity.Entities;
import easy.media.marketing.os.framework.api.query.Queries;
import easy.media.marketing.os.framework.api.repository.Repositories;
